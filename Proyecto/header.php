  ...
  <body>
        <div class="header" style="display: block;">
          <nav class="navbar navbar-expand sticky-top navbar-dark bg-dark">
            ...
            <a class="navbar-brand" onclick="NoLog(<?php echo $bandera; ?>)" href="<?php if($bandera){echo 'carrito.php';}else{echo 'logUser.php';} ?>" style="position: absolute;right: 65px;  " ><img src="imagenes/carrito.png" alt="Carrito">
